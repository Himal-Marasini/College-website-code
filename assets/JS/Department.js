const btn_viewProfiles = document.querySelectorAll(".view_profile");
const main_container = document.querySelector(".modal_container");
...
const modalContainer = document.querySelector(".main_container");
const forOverlay = document.querySelector(".forsection_overlay");
const goBack = document.querySelector(".goBack");
const forShadows = document.querySelectorAll(".for_shadow");
